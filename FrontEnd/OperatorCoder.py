...
with open("dropdowns.html", "w") as html_file:
    ...
    html_file.write("<select id='firstDropdown' onchange='change_dropdown()'>\n")
    ...
    html_file.write("<select id='secondDropdown'>\n")
    html_file.write("</select>\n")
    html_file.write("<script>\n")
    html_file.write("function change_dropdown() {\n")
    html_file.write("var selectedValue = document.getElementById('firstDropdown').value;\n")
    html_file.write("var secondDropdown = document.getElementById('secondDropdown');\n")
    html_file.write("secondDropdown.innerHTML = '';\n")
    for main_value in sorted(values_dict.keys()):
        ...
        for sub_value in values_dict[main_value]:
            ...
            html_file.write("secondDropdown.add(option);\n")
        html_file.write("}\n")
    html_file.write("}\n")
    html_file.write("</script>\n")
    html_file.write("</body>\n")
